namespace GameUtilities.Components
{
    namespace Camera
    {
        ...
        public class ComponentConstants
        {
            ...
            /// </summary>
            public static readonly string CAM_ZNEAR = "CamNear";

            /// <summary>
            /// The camera's Far Plane
            /// </summary>
            public static readonly string CAM_ZFAR = "CamFar";

            /// <summary>
            /// The camera's type (ORTHOGRAPHIC|PERSPECTIVE)
            /// </summary>
            public static readonly string CAM_TYPE = "CamType";
            ...
            /// </summary>
            public static readonly string CAM_FOV = "CamFOV";

            /// <summary>
            /// The camera's aspect ratio
            /// </summary>
            public static readonly string CAM_ASPECT = "CamAspect";

            /// <summary>
            /// The camera's width
            /// </summary>
            public static readonly string CAM_WIDTH = "CamWidth";

            /// <summary>
            /// The camera's height
            /// </summary>
            public static readonly string CAM_HEIGHT = "CamHeight";
        }
    }
}
